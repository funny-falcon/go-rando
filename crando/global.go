...
// Global source uses sync.Pool, so it is relatively cheap.
...
var pool = &global{Pool: sync.Pool{New: func() interface{} {
	return NewCrand()
}}}
...
func (g *global) Int63() int64 {
	return int64(g.Uint64() >> 1)
}

func (g *global) Seed(i int64) {}
